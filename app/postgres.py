"""
Sets up and manages the asynchronous database engine and sessions using
SQLAlchemy. Provides helpers to configure connections, create sessions,
initialize schema, and apply triggers during application startup.
"""
