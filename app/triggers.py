"""
Defines PostgreSQL triggers and a helper function that keep the
collections.documents_count column in sync by updating counts on
INSERT, UPDATE, and DELETE operations in the documents table, and
performs an initial backfill to ensure consistency.
"""
