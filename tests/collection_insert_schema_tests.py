...
from app.schemas.collection_insert_schema import CollectionInsertRequest
...
class CollectionInsertSchemaTest(unittest.TestCase):
    ...
    def test_collection_name_lengh_min(self):
        ...
        res = CollectionInsertRequest(**data)
        self.assertEqual(res.collection_name, "a")
