...
from app.schemas.collection_list_schema import CollectionListRequest
from app.config import get_config

cfg = get_config()


class TestCollectionListRequest(unittest.TestCase):
    ...
    def test_correct(self):
        ...
        schema = CollectionListRequest(**data)
    ...
    def test_order_by_correct(self):
        orders_bys = ["id", "user_id", "collection_name_index"]
