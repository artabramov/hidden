...
from app.schemas.folder_insert import (
    FolderInsertRequest, FolderInsertResponse)


class FolderInsertSchemaTest(unittest.TestCase):

    def test_request_correct(self):
        res = FolderInsertRequest(readonly=False, name="Dummy")
    ...
    def test_request_extra_forbidden(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderInsertRequest(readonly=False, name="Dummy", foo="bar")
    ...
    def test_request_readonly_missing(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderInsertRequest(name="Dummy")
    ...
    def test_request_readonly_string_empty(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderInsertRequest(readonly="", name="Dummy")
    ...
    def test_request_readonly_string_dummy(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderInsertRequest(readonly="dummy", name="Dummy")
    ...
    def test_request_readonly_string_0(self):
        res = FolderInsertRequest(readonly="0", name="Dummy")
        self.assertEqual(res.readonly, False)

    def test_request_readonly_string_1(self):
        res = FolderInsertRequest(readonly="1", name="Dummy")
    ...
    def test_request_readonly_string_true(self):
        res = FolderInsertRequest(readonly="true", name="Dummy")
        self.assertEqual(res.readonly, True)

    def test_request_readonly_string_not_stripped(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderInsertRequest(readonly=" true ", name="Dummy")
    ...
    def test_request_name_missing(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderInsertRequest(readonly=False)
    ...
    def test_request_name_string_empty(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderInsertRequest(readonly=False, name="")
    ...
    def test_request_name_string_too_long(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderInsertRequest(readonly=False, name="X" * 256)
    ...
    def test_request_name_string_shortest(self):
        res = FolderInsertRequest(readonly=False, name="X")
        self.assertEqual(res.name, "X")

    def test_request_name_string_longest(self):
        res = FolderInsertRequest(readonly=False, name="X" * 255)
    ...
    def test_response_correct(self):
        res = FolderInsertResponse(folder_id=123)
    ...
    def test_response_folder_id_none(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderInsertResponse(folder_id=None)
    ...
    def test_response_folder_id_string_empty(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderInsertResponse(folder_id="")
    ...
    def test_response_folder_id_string_dummy(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderInsertResponse(folder_id="dummy")
    ...
    def test_response_folder_id_string_integer(self):
        res = FolderInsertResponse(folder_id="123")
        self.assertEqual(res.folder_id, 123)
