...
class FolderUpdateSchemaTest(unittest.TestCase):
    ...
    def test_request_correct(self):
        res = FolderUpdateRequest(readonly=False, name="Dummy")
    ...
    def test_request_readonly_missing(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderUpdateRequest(name="Dummy")
    ...
    def test_request_readonly_none(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderUpdateRequest(readonly=None, name="Dummy")
    ...
    def test_request_readonly_string(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderUpdateRequest(readonly="not-int", name="Dummy")
    ...
    def test_request_readonly_integer(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderUpdateRequest(readonly=123, name="Dummy")
    ...
    def test_request_readonly_coercion_integer_0(self):
        res = FolderUpdateRequest(readonly=0, name="Dummy")
        self.assertEqual(res.readonly, False)

    def test_request_readonly_coercion_integer_1(self):
        res = FolderUpdateRequest(readonly=1, name="Dummy")
    ...
    def test_request_readonly_coercion_string_true(self):
        res = FolderUpdateRequest(readonly="true", name="Dummy")
        self.assertEqual(res.readonly, True)
    ...
    def test_request_name_missing(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderUpdateRequest(readonly=False)
    ...
    def test_request_name_none(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderUpdateRequest(readonly=False, name=None)
    ...
    def test_request_name_string_too_short(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderUpdateRequest(readonly=False, name="")
    ...
    def test_request_name_string_too_long(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderUpdateRequest(readonly=False, name="X" * 256)
    ...
    def test_request_name_string_shortest(self):
        res = FolderUpdateRequest(readonly=False, name="X")
        self.assertEqual(res.name, "X")

    def test_request_name_string_longest(self):
        res = FolderUpdateRequest(readonly=False, name="X" * 255)
    ...
    def test_response_correct(self):
        res = FolderUpdateResponse(folder_id=123)
    ...
    def test_response_folder_id_none(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderUpdateResponse(folder_id=None)
    ...
    def test_response_folder_id_string(self):
        with self.assertRaises(ValidationError) as ctx:
            FolderUpdateResponse(folder_id="not-int")
    ...
    def test_response_folder_id_coercion(self):
        res = FolderUpdateResponse(folder_id="123")
        self.assertEqual(res.folder_id, 123)
