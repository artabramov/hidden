# tests/schemas/test_cipherdir_mount.py
...
from app.schemas.cipherdir_mount import CipherdirMountRequest


class TestCipherdirMountRequest(unittest.TestCase):

    def test_accepts_valid_master_password(self):
        req = CipherdirMountRequest(
